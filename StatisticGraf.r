...
StatisticGraf <- function(rf, N) {#задаем имя и параметры функции
  #функция выполняет упражнение 6
  #параметр args:
  #rt - это вектор, который содержит распределение х
  #N - это вектор, который содержит распределение е
  # Результат - функция рисует и сохраняет гистограмму, функция не возвращает значения
  #константы 
n <- 28 #мой вариант
number <- 300
